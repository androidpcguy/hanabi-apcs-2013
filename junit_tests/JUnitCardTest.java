...
public class JUnitCardTest {
	...
	public void equalsTest() {
		assertTrue(testCard.equals(new Card(1, RED)));
		assertFalse(testCard.equals(new Card(1, BLUE)));
		assertFalse(testCard.equals(new Card(2, RED)));
		assertFalse(testCard.equals(new Card(2, BLUE)));
	}
